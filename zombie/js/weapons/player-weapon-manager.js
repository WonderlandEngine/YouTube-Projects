...
export class PlayerWeaponManager extends Component {
    ...
    start() {
        ...
        // The weapon object of the player, to change its position on aim
        this.playerWeaponParent = this.currentWeapon?.parent;
    }
    ...
    startAim() {
        ...
        // Call weapon position component to transition to aim position
        this.playerWeaponParent
            ?.getComponent('change-weapon-position-on-action')
            ?.startAim();
    }
    ...
    endAim() {
        ...
        // Call weapon position component to transition back to default position
        this.playerWeaponParent?.getComponent('change-weapon-position-on-action')?.endAim();
    }
    ...
    reloadWeapon() {
        ...
        // Start weapon reload position transition
        this.playerWeaponParent
            ?.getComponent('change-weapon-position-on-action')
            ?.startReload();
        ...
        setTimeout(() => {
            ...
            // End weapon reload position transition
            this.playerWeaponParent
                ?.getComponent('change-weapon-position-on-action')
                ?.endReload();
