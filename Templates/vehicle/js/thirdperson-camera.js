...
export class ThirdpersonCamera extends Component {
    ...
    static Properties = {
        ...
        playerSpine: Property.object(), // The spine bone of the player, used for vertical aiming
    ...
    startAim() {
        this.isAiming = true;
        this.player?.getComponent('tps-movement')?.setAiming(true);
        // this.player?.getComponent('animation-controller')?.setAnimation('aimIdle');
    ...
    endAim() {
        this.isAiming = false;
        this.player?.getComponent('tps-movement')?.setAiming(false);
    ...
    rotatePlayerToCamera() {
        const playerForward = vec3.create();
        ...
        // Calculate the yaw angle from forward vector
